...
const SITE_SEED = {
  settings: {
    siteName: 'Tink Photo Gallery',
    shortName: 'Tink.',
    siteUrl: 'https://tinks.netlify.app',
    locale: 'zh-CN',
    homeTitle: '影像故事',
    homeIntro: '欢迎来到 Tink 的摄影学习日记，记录城市、自然与旅途中的影像故事。',
    defaultSeoTitle: 'Tink Photo Gallery',
    defaultSeoDescription: '欢迎来到 Tink 的摄影学习日记，记录城市、自然与旅途中的影像故事。',
    analyticsJson: {},
  },
  about: {
    name: 'Tink',
    ...
    profileItems: [
      { label: '我是', value: 'Tink', href: '', external: false },
